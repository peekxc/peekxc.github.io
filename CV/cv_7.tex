...
\cventry{Web and Complex Systems Lab}
			 ...
			 {2015 - 2018}{}
{  \vspace{3pt}
I joined the Web and Complex Systems (WaCS) lab in 2015 initially as part of an independent study, which in turn lead to a graduate research assistantship. I was assigned to a research project aimed at modeling macroscopic aspects of real-world traffic networks via a dynamic network model (i.e. a modified stochastic block model). The topic areas I focused on for the project include: 
	\begin{itemize}
