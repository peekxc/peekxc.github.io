...
Additional research on the utility of Generative Adversarial Networks (GANs) and their potential for generating certain types of spatiotemporal data, e.g. trajectory data which is characteristically indistinguishable from a given set of trajectory data, is ongoing. My research is supported by the Center for Surveillance Research, a National Science Foundation I/UCRC.
}
