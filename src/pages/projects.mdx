...
<section class="space-y-3 text-center">
  <p class="text-xs uppercase tracking-[0.5em] text-ink-muted">Research</p>
  <h1 class="text-4xl font-semibold text-ink-strong">Highlighted Projects</h1>
  <p class="mx-auto max-w-2xl text-sm text-ink-muted">
...
<div class="my-6 flex flex-col gap-6">
    ...
    <CardSection title="Software">
      <div class="grid gap-0">
        <div class="py-2 first:pt-0 last:pb-0">
          <a href="https://github.com/peekxc/pbsig" target="_blank" rel="noreferrer">pbsig</a>
        </div>
        <div class="py-2 first:pt-0 last:pb-0">
          <a href="https://github.com/peekxc/primate" target="_blank" rel="noreferrer">primate (package for trace estimation)</a>
        </div>
        <div class="py-2 first:pt-0 last:pb-0">
          <a href="https://github.com/peekxc/simplextree" target="_blank" rel="noreferrer">simplextree (python package)</a>
        </div>
      </div>
    </CardSection>

    <CardSection title="Related materials">
      <a href="https://www.youtube.com/watch?v=EGP4GlcLNYU&t=505s" target="_blank" rel="noreferrer">CompPers23 talk (YouTube)</a>
    </CardSection>
  </ProjectCard>
  ...
  >
    ...
    <CardSection title="Software">
      <div class="grid gap-0">
        <div class="py-2 first:pt-0 last:pb-0">
          <a href="https://github.com/peekxc/move_schedules" target="_blank" rel="noreferrer">Move scheduling code</a>
        </div>
        <div class="py-2 first:pt-0 last:pb-0">
          <a href="https://github.com/peekxc/simplextree" target="_blank" rel="noreferrer">simplextree (python package)</a>
        </div>
  ...
  >
    ...
    <CardSection title="Software">
      <div class="grid gap-0">
        <div class="py-2 first:pt-0 last:pb-0">
          <a href="https://peekxc.github.io/Mapper/" target="_blank" rel="noreferrer">Mapper (R package)</a>
        </div>
        <div class="py-2 first:pt-0 last:pb-0">
          <a href="https://github.com/peekxc/simplextree" target="_blank" rel="noreferrer">simplextree (R package)</a>
        </div>
        <div class="py-2 first:pt-0 last:pb-0">
          <a href="https://peekxc.github.io/Mapper/articles/ShapeRecognition.html" target="_blank" rel="noreferrer">Vignette on using Mapper for shape recognition</a>
        </div>
      </div>
    </CardSection>
  </ProjectCard>
  ...
  >
    ...
    <CardSection title="Software">
      <div class="grid gap-0">
        <div class="py-2 first:pt-0 last:pb-0">
          <a href="https://github.com/mhahsler/dbscan" target="_blank" rel="noreferrer">dbscan (R package)</a>
        </div>
        <div class="py-2 first:pt-0 last:pb-0">
          <a href="https://cran.r-project.org/web/packages/dbscan/vignettes/hdbscan.html" target="_blank" rel="noreferrer">HDBSCAN vignette</a>
        </div>
      </div>
    </CardSection>
  </ProjectCard>
