...
code_links: {
  "example" : "https://peekxc.github.io/primate/theory/matrix_functions.html",
  "intro" : "https://peekxc.github.io/primate/theory/intro.html", 
  "overview" : "https://peekxc.github.io/primate/"
}
date: 2024-01-05
---

Provides estimators of _trace_ or _vector_-based quantities derived from [matrix functions](https://en.wikipedia.org/wiki/Analytic_function_of_a_matrix#Diagonalizable_matrices), i.e. matrices whose spectra are parameterized by functions. 

$$f(A) \triangleq Uf(\Lambda)U, \quad f : [a,b] \to \mathbb{R} $$

This definition is quite general in that different parameterizations of $f$ produce a variety of spectral quantities, including e.g. the [numerical rank](https://doi.org/10.1016/j.amc.2007.06.005), the [log-determinant](https://en.wikipedia.org/wiki/Determinant#Trace), the trace inverse, the [Schatten norms](https://en.wikipedia.org/wiki/Schatten_norm), the trace of [matrix exponentials](https://en.wikipedia.org/wiki/Matrix_exponential), the [eigencount](https://doi.org/10.1002/nla.2048), the [spectral density](https://doi.org/10.1137/130934283), and so on. 
<br/>
<br/>
