...
The method is extremely fast, uses very little working memory, does not involve any complicated data structures. Moreover, though it was developed with the Euclidean metric in mind, the method is actually extendeable to any metric. 
