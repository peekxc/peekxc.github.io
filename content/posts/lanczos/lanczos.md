...
eigen-decomposition is not only guaranteed to exist, but its [canonical
...
we have effectively solved the eigenvalue problem for $A$.

To quote the [Lanczos introduction from
